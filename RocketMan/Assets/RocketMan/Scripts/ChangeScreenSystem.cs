...
namespace RocketMan
{
    public class ChangeScreenSystem : ComponentSystem
    {
        protected override void OnUpdate()
        {
            ...
            Entities.ForEach((Entity entity, ref Rocket rocket, ref Sprite2DRenderer sprite2DRenderer, ref Translation Transform, ref NonUniformScale nonUniformScale) =>
            {
                nonUniformScale.Value = new float3(1, 1, 1);
                Transform.Value.y = -12;
                Transform.Value.x = 0;
                sprite2DRenderer.color.a = 1;
            });
